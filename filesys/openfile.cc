...
// for L5E7
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
    synchDisk->numVisitor[hdr->getSectorNum()] ++;
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
    seekPosition = 0;
}
...
// Lab 5 Exercise 7
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
   //printf("Thread '%s' tries to read.\n", currentThread->getName()); // for E7 test
   //currentThread->Yield(); // for E7 test

   synchDisk->PlusReader(hdr->getSectorNum());
   int result = ReadAt(into, numBytes, seekPosition);

   seekPosition += result;
   synchDisk->MinusReader(hdr->getSectorNum());
   return result;
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
}
...
// Lab 5 Exercise 7
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
   //printf("Thread '%s' tries to write.\n", currentThread->getName()); // for E7 test

   synchDisk->BeginWrite(hdr->getSectorNum());
   int result = WriteAt(into, numBytes, seekPosition);

   //currentThread->Yield(); // for E7 test

   seekPosition += result;
   synchDisk->EndWrite(hdr->getSectorNum());
   return result;
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
}
...
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
    ...
    hdr->WriteBack(hdr->getSectorNum());
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
...
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
    ...
    if ((position + numBytes) > fileLength) {
        ...
        hdr->ExtendLen(freeMap, position + numBytes - fileLength);
